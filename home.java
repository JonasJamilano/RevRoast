...
public class home extends JFrame {
    ...
    private Connection roleConn; // ✅ Added this for role-based DB connection

    public home() {
        this(null, null, null); // Guest constructor
    }

    public home(String username) {
        this(username, null, null); // For backward compatibility
    }

    public home(String username, Integer userId, Connection roleConn) { // ✅ Updated constructor
        this.currentUserId = userId;
        this.currentUsername = username;
        this.roleConn = roleConn; // ✅ Store role-based connection
        ...
        if (currentUsername == null) {
            ...
            orderHistoryBtn.addActionListener(e -> {
                new OrderHistory(currentUserId).setVisible(true);
                dispose();
            });
        }
    ...
    private String getCustomerName(int userId) {
        try (PreparedStatement stmt = roleConn.prepareStatement( // ✅ Use roleConn instead of default connection
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                new home(null, null, null).setVisible(true); // ✅ Updated main()
            } catch (Exception e) {
