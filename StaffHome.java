...
public class StaffHome extends JFrame {
    ...
    private Connection roleConn; // ✅ Added this for role-based connection

    // ✅ Updated constructor to accept Connection
    public StaffHome(String username, Connection roleConn) {
        this.username = username;
        this.roleConn = roleConn; // ✅ Store the connection
        initializeUI();
    }
    ...
    private JPanel createButtonPanel() {
        ...
        processOrdersBtn.addActionListener(e -> openWindow(new ProcessOrders(username)));
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new StaffHome("test_staff", null)); // ✅ Added null for roleConn
    }
}
